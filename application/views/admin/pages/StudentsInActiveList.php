...
<div class="wrapper">
  ...
  <!-- Content Wrapper. Contains page content -->
    ...
    <section class="content-header">
      <h1>
        <?php $LangList = $this->db->query('SELECT English,Urdu FROM language WHERE English = "Student Active List"')->row(); if(!empty($LangList)){ echo $LangList->$Word; }else{echo "Student Active List";}?>
      </h1>
    </section>
    <!-- Main content -->
...
function ViewStudent(Id) {
                    ...
                    var edit_data = new FormData();
                      ...
                      $.ajax({
                        url:"<?php echo base_url('Admin/StudentsInActiveList/View'); ?>",
                        method:"POST",
                        dataType: 'JSON',
                        data: edit_data,
                        contentType: false,
...
function DeActiveStudent(Id) {
      ...
      .then((willDelete) => {
        if (willDelete) {
          $.ajax({
                        url:"<?php echo base_url('Admin/StudentsInActiveList/Delete'); ?>",
                        method:"POST",
                        dataType: 'JSON',
                        data: form_data,
                        contentType: false,
...
function DeleteStudent(Id) {
      ...
      .then((willDelete) => {
        if (willDelete) {
          $.ajax({
                        url:"<?php echo base_url('Admin/StudentsInActiveList/DeleteStudent'); ?>",
                        method:"POST",
                        dataType: 'JSON',
                        data: form_data,
                        contentType: false,
                ...
                if(StudentName == ""){
                  ...
                  var form_data = new FormData();
                      ...
                      form_data.append("StudentImage", document.getElementById('imgInp2').files[0]);
                          $.ajax({
                        url:"<?php echo base_url('Admin/StudentsInActiveList/Edit'); ?>",
                        method:"POST",
                        dataType: 'JSON',
                        data: form_data,
                        contentType: false,
        ...
        function DownloadDoc(StudentId) {
          ...
          $.ajax({
          url:"<?php echo base_url('Admin/StudentsInActiveList/Download'); ?>",
          method:"POST",
          dataType: 'JSON',
          data: form_data,
          contentType: false,
