...
<body>
<div id="printelement">
    <?php if (!empty($BulkFee)) {
        foreach ($BulkFee as $Voucher) {

            // $OutStandingAmount = $this->Admindb->getdata(['StudentId'=>$Voucher->StudentId,'FeeId !='=>$Voucher->FeeId,'IsActive'=>true,'IsDeleted'=>false],'fee','Id','ASC');/**********get data*********** */

            $StudentFeeData = $this->Admindb->CheckConditionData(['FeeId' => $Voucher->FeeId, 'IsActive' => true, 'IsDeleted' => false], 'fee');


            $OutStanding = $this->Admindb->SumRecord(['StudentId' => $Voucher->StudentId, 'MonthNumber <>' =>0,'MonthNumber <' => $StudentFeeData->MonthNumber, 'IsActive' => true, 'IsDeleted' => false], 'Dues', 'fee');
            $Dues_OutStanding = $this->Admindb->SumRecord(['StudentId' => $Voucher->StudentId, 'MonthNumber <' => $StudentFeeData->MonthNumber, 'IsActive' => true, 'IsDeleted' => false], 'Dues', 'fee');
          ...
          <div class="fv-col">
            ...
            <table id="voucher0" style="border-collapse: collapse; width: 0%; font-size: 12px;">
              ...
              <tr class="fv-borderbottom">
                ...
                <td colspan="2" style=" border-bottom: 1pt solid rgb(0, 0, 0); text-align:right;"><strong>BANK's
                    COPY</strong></td>
              </tr>
              <tr>
                ...
                <td>&nbsp;</td>
                <td><strong>Due Date: <br><span id="reptrData_lblDueDate_0"
              ...
              <tr class="fv-borderall fv-maintext">
                ...
                <td style="padding: 2px; height: 25px; width: 94px; text-align: center; text-transform: uppercase !important; border: 1pt solid rgb(0, 0, 0);">
                  <strong>
                    ...
                    <!--       <span id="reptrData_lblFess_0" style="font-size:smaller ; text-transform:uppercase">-->
                      <?php //if(!empty($Voucher->Fee)){ if($Voucher->Dues > 0){ echo $Voucher->Fee; }else{ echo "Paid"; } } ?><!--</span>-->
                  </strong></td>
...
<!--                $where,$table,$orderid,$orderby-->
              ...
              <tr class="fv-borderall fv-maintext">
                <td colspan="2"
                  ...
                  PAYABLE BEFORE DUE DATE (<strong><span
                        id="reptrData_lblDueDate0_0"><?php if (!empty($Voucher->DueDate)) {
                                if ($Voucher->Dues > 0) {
                                    echo $Voucher->DueDate;
                                } else {
                                    echo "Paid";
                ...
                <td style="padding: 2px; height: 25px; width: 94px; text-align: center; text-transform: uppercase !important; border: 1pt solid rgb(0, 0, 0);">
                  <strong>
                    <span id="reptrData_lblPayableFees_0"
                          style="font-size:smaller ; text-transform:uppercase"><?php if (!empty($Voucher->Fee)) {
                            if ($Voucher->Dues > 0) {
                                echo $Voucher->Dues + $Dues_OutStanding;
                            } else {
                                echo "Paid";
                            }
                        } ?></span>
                ...
                <td style="padding: 2px; height: 25px; width: 94px; text-align: center; text-transform: uppercase !important; border: 1pt solid rgb(0, 0, 0);">
                  <strong>
                    <span id="reptrData_lblDueFees_0"
                          style="font-size:smaller ; text-transform:uppercase"><?php if (!empty($Voucher->Fee)) {
                            if ($Voucher->Dues > 0) {
                                echo $Voucher->Dues + $Dues_OutStanding + 500;
                            } else {
                                echo "Paid";
                            }
                        } ?></span>
              ...
              <tr class="fv-infotext">
                <td colspan="2" style="padding: 2px; height: 10px; width: 256px; font-size: 11px;"><strong>Instruction
                    for Parents:</strong></td>
                <td style="padding: 2px; height: 10px; width: 95px; font-size: 11px;"></td>
              </tr>
              <tr>
                <td colspan="3" style="padding: 2px; height: 10px; width: 355px;">1. Fee Challan for each month are
                  provided to student by
                  their class teacher in last week of running month. However if it is not received or not delivered by
                  the child , it will be responsibility of
              ...
              <tr>
                <td colspan="3" style="padding: 2px; height: 10px; width: 355px;">2. Rs50 will be charged incase of
                  misplacing or lost of voucher.
                </td>
              </tr>
              <tr>
                <td style="padding: 2px; height: 10px; width: 151px;"></td>
              ...
              <tr>
                <td colspan="3" style="padding: 2px; height: 10px; width: 355px;">3. Monthly fee is non-refundable even
                  of June and July.
                </td>
              </tr>
              <tr>
              ...
              <tr>
                <td colspan="3" style="padding: 2px; height: 10px; width: 355px;font-size:11px;"><strong>Note: Please
                    collect your computerised receipt after fee payment</strong></td>
              </tr>
              <tr>
                <td style="padding: 2px; height: 10px; width: 151px;"></td>
                <td style="padding: 2px; height: 10px;"></td>
              ...
              <tr>
                <td colspan="2" style="padding: 2px; height: 10px; width: 256px;font-size: 11px;">For any querries feel
                  free to contact:
                </td>
                <td style="padding: 2px; height: 10px; width: 95px;"></td>
              </tr>
          ...
          <div class="fv-col">
            ...
            <table id="voucher0" style="border-collapse: collapse; width: 0%; font-size: 12px;">
              ...
              <tr>
                ...
                <td colspan="2" style="padding: 2px;text-align:right">
                  <span id="reptrData_Label1_0">Bank Al Habib<br>A/C.No: 1119-0981-002188-01-8 </span></td>
              </tr>
              <tr>
                <td colspan="3" style="padding: 2px; height: 10px; width: 355px; text-align: right;">
                  <span id="reptrData_lblCampusBankRef0_0"></span>
                </td>
              </tr>
              <tr class="fv-borderbottom">
                <td style="border-bottom: 1pt solid rgb(0, 0, 0);">Fee Challan</td>
                <td colspan="2" style="border-bottom: 1pt solid rgb(0, 0, 0); text-align:right;"><strong>SCHOOL's
                    COPY</strong></td>
              </tr>
              <tr>
                ...
                <td>&nbsp;</td>
                <td><strong>Due Date:<br><span id="reptrData_lblDueDate1_0"
                                               style="font-size:smaller"><?php if (!empty($Voucher->DueDate)) {
                                echo $Voucher->DueDate;
                            } ?></span></strong></td>
              </tr>
              ...
              <tr class="fv-borderbottom">
                ...
                <td style="padding: 2px; height: 10px; width: 95px; border-bottom: 1pt solid rgb(0, 0, 0);"><strong>Class:
                    ...
                    &nbsp;<span id="reptrData_lblSection0_0"
                                style="font-size:smaller; text-transform:uppercase">A</span>
                  </strong></td>
              </tr>
              <tr class="fv-borderbottom">
                <td style="padding: 2px; height: 10px; width: 151px; border-bottom: 1pt solid rgb(0, 0, 0);"></td>
              ...
              <tr class="fv-borderall fv-maintext">
                <td colspan="2"
                  ...
                  PAYABLE BEFORE DUE DATE (<strong><span
                        id="reptrData_lblDueDate2_0"><?php if (!empty($Voucher->DueDate)) {
                                if ($Voucher->Dues > 0) {
                                    echo $Voucher->DueDate;
                                } else {
                                    echo "Paid";
              ...
              <tr>
                <td colspan="3" style="padding: 2px; height: 10px; width: 355px;">1. Fee Challan for each month are
                  provided to student by their
                  class teacher in last week of running month. However if it is not
                  received or not delivered by the child , it will be responsibility of parents to collect the fee
                  challan respective campus.
                </td>
              </tr>
              <tr>
                <td style="padding: 2px; height: 10px; width: 151px;"></td>
          ...
          <div class="fv-col">
            ...
            <table id="voucher0" style="border-collapse: collapse; width: 0%; font-size: 12px;">
              ...
              <tr>
                <td colspan="3" style="padding: 2px; height: 10px; width: 355px; text-align: right;">
                  <span id="reptrData_lblCampusBankRef1_0"></span>
                </td>
              </tr>
              <tr class="fv-borderbottom">
                <td style="padding: 2px; height: 10px; width: 151px; border-bottom: 1pt solid rgb(0, 0, 0);">Fee
                  Challan
                </td>
                <td colspan="2"
                    style="padding: 2px; height: 10px; width: 95px; border-bottom: 1pt solid rgb(0, 0, 0); text-align:right;">
                  <strong>PARENT's COPY</strong></td>
              </tr>
              <tr>
              ...
              <tr class="fv-borderall fv-maintext">
                <td colspan="2"
                  ...
                  PAYABLE BEFORE DUE DATE (<strong><span
                        id="reptrData_lblDueDate4_0"><?php if (!empty($Voucher->DueDate)) {
                                if ($Voucher->Dues > 0) {
                                    echo $Voucher->DueDate;
                                } else {
                                    echo "Paid";
              ...
              <tr class="fv-infotext">
                <td colspan="2" style="padding: 2px; height: 10px; font-size: 11px;"><strong>Instruction for
                    Parents:</strong></td>
                <td style="padding: 2px; height: 10px; width: 95px; font-size: 11px;"></td>
              </tr>
              <tr>
                <td colspan="3" style="padding: 2px; height: 10px; width: 355px;">1. Fee Challan for each month are
                  provided to student by their class teacher in last week of running month. However if it is not
              ...
              <tr>
                <td colspan="2" style="padding: 2px; height: 10px;font-size:11px; ">For any querries feel free to
                  contact:
                </td>
                <td style="padding: 2px; height: 10px; width: 95px;"></td>
              </tr>
              ...
              <tr>
                <td colspan="2" style="padding: 2px; height: 10px; ">
                  <span id="reptrData_lblCampusEmail1_0"
                        style="font-size:11px"><?php if (!empty($CompanyList->CompanyEmail)) {
                          echo $CompanyList->CompanyEmail;
                      } ?></span>
                </td>
                <td style="padding: 2px; height: 10px; width: 95px;"></td>
...
<!-- <button type="button" class="form-control btn btn-primary" onclick="PrintVoucher()" style="width:6%; float:right; margin:2%">Print</button> -->
...
<script>
  function PrintVoucher() {
    ...
    var a = window.open('', '', 'height=600, width=1300');
