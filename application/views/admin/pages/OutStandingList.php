...
<div class="wrapper">
  ...
  <!-- Content Wrapper. Contains page content -->
    ...
    <section class="content-header">
      <h1>
        <?php $LangList = $this->db->query('SELECT English,Urdu FROM language WHERE English = "Summary"')->row(); if(!empty($LangList)){ echo $LangList->$Word; }else{echo "Summary";}?>
      </h1>
      ...
      <div class="box box-default">
        ...
        <div class="box-body">
          <div class="row">
            <div class="box-body">
              <div class="row">
              <form method="post" action="<?php echo base_url('OutStandingList/ClassSearch'); ?>">
                <div class="col-md-12">
                  <h3>Class Search</h3>
                </div>
                <div class="col-md-3">
              ...
              <div class="row" style="margin-top:20px;">
                <form method="post" action="<?php echo base_url('OutStandingList/MonthlySearch'); ?>">
                    <div class="col-md-12">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <th class="text-center"><?php $LangList = $this->db->query('SELECT English,Urdu FROM language WHERE English = "OutStanding"')->row(); if(!empty($LangList)){ echo $LangList->$Word; }else{echo "OutStanding";}?></th>
                  <th class="text-center"><?php $LangList = $this->db->query('SELECT English,Urdu FROM language WHERE English = "Total"')->row(); if(!empty($LangList)){ echo $LangList->$Word; }else{echo "Total";}?></th>
                ...
                <tbody id="feedetails">
                  <?php $i = 1; if(!empty($StudentList)){ foreach ($StudentList as $STULIS) {  
                    ...
                    $OutStanding = $this->Admindb->SumRecord(['StudentId'=>$STULIS->StudentId,'MonthNumber <'=>$STULIS->MonthNumber,'IsActive'=>true,'IsDeleted'=>false],'Dues','fee');
                    ?>
                <tr>
                  ...
                  <td class="text-center"><?php echo $STULIS->Fee + $OutStanding; ?></td>
                </tr>
              ...
              function filterdata(){
                ...
                var form_data = new FormData();
                      ...
                      form_data.append("Year", Year);
                          $.ajax({
                        url:"<?php echo base_url('Admin/OutStandingList/Filter'); ?>",
                        method:"POST",
                        dataType: 'JSON',
                        data: form_data,
                        contentType: false,
