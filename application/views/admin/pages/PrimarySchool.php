...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <?php $LangList = $this->db->query('SELECT English,Urdu FROM language WHERE English = "Primary School"')->row(); if(!empty($LangList)){ echo $LangList->$Word; }else{echo "Primary School";}?>
      </h1>
    </section>
    <!-- Main content -->
...
<script>
  ...
  function DeleteOk() {
                      ...
                      $.ajax({
                        url:"<?php echo base_url('Admin/PrimarySchool/Delete'); ?>",
                        method:"POST",
                        dataType: 'JSON',
                        data: form_data,
                        contentType: false,
                        ...
                        success:function(data)
                        {
                          if (data.status == true) {
                            ...
                            $.ajax({
                                url:"<?php echo base_url('Admin/PrimarySchool'); ?>",
                                beforeSend: function(){
                                $("#page-loader").show();
                                },
                                complete: function(){
  ...
  function BlockSchool(Id) {
                      ...
                      $.ajax({
                        url:"<?php echo base_url('Admin/PrimarySchool/Block'); ?>",
                        method:"POST",
                        dataType: 'JSON',
                        data: form_data,
                        contentType: false,
                  ...
                  function EditSchool(Id) {
                    ...
                    var edit_data = new FormData();
                      ...
                      $.ajax({
                        url:"<?php echo base_url('Admin/PrimarySchool/View'); ?>",
                        method:"POST",
                        dataType: 'JSON',
                        data: edit_data,
                        contentType: false,
          ...
          /**************** Insert Department Field Using Ajax *************/
              function UpdateSchool(Id) {
                ...
                if (SchoolName != "" && SchoolAddress != "" && SchoolType != "") {
                    $.ajax({
                  url:"<?php echo base_url('Admin/PrimarySchool/Edit'); ?>",
                  method:"POST",
                  dataType: 'JSON',
                  data: form_data,
                  contentType: false,
