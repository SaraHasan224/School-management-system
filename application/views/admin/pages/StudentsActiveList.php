...
function ViewStudent(Id) {
                    ...
                    var edit_data = new FormData();
                      ...
                      $.ajax({
                        url:"<?php echo base_url('Admin/StudentsActiveList/View'); ?>",
                        method:"POST",
                        dataType: 'JSON',
                        data: edit_data,
                        contentType: false,
...
function DeActiveStudent(Id) {
      ...
      .then((willDelete) => {
        if (willDelete) {
          $.ajax({
                        url:"<?php echo base_url('Admin/StudentsActiveList/Delete'); ?>",
                        method:"POST",
                        dataType: 'JSON',
                        data: form_data,
                        contentType: false,
...
function DeleteStudent(Id) {
      ...
      .then((willDelete) => {
        if (willDelete) {
          $.ajax({
                        url:"<?php echo base_url('Admin/StudentsActiveList/DeleteStudent'); ?>",
                        method:"POST",
                        dataType: 'JSON',
                        data: form_data,
                        contentType: false,
                ...
                if(StudentName == ""){
                  ...
                  var form_data = new FormData();
                      ...
                      form_data.append("StudentImage", document.getElementById('imgInp2').files[0]);
                          $.ajax({
                        url:"<?php echo base_url('Admin/StudentsActiveList/Edit'); ?>",
                        method:"POST",
                        dataType: 'JSON',
                        data: form_data,
                        contentType: false,
        ...
        function DownloadDoc(StudentId) {
          ...
          $.ajax({
          url:"<?php echo base_url('Admin/StudentsActiveList/Download'); ?>",
          method:"POST",
          dataType: 'JSON',
          data: form_data,
          contentType: false,
