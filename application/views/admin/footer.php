...
<footer class="main-footer">
    ...
    <strong>Powered by <a href="http://jemstech.net/">Jemstech</a>.</strong>
    reserved.
</footer>
  <!-- Control Sidebar -->
...
<!-- <script src="<?php //echo base_url('assets/jQuery-Input-Mask-Phone-Numbers/dist/jquery-input-mask-phone-number.js'); ?>"></script> -->
<!-- DataTables -->
...
<!-- Snack Bar Notification Js -->
<script src="<?php echo base_url('SnackBar/dist/snackbar.min.js');?>"></script> 
<!-- InputMask -->
...
<script src="<?php echo base_url('AdminLTE/plugins/bootstrap-slider/bootstrap-slider.js'); ?>"></script>
<!-- fullCalendar -->
<script src="<?php echo base_url('assets/node_modules/sweetalert/dist/sweetalert.min.js'); ?>"></script>
<script src="<?php echo base_url('assets/dist/js/download.js'); ?>"></script>
<script src="<?php echo base_url('assets/dist/js/smsjs.js'); ?>"></script>
