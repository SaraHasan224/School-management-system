...
<div class="login-box">
  <div class="login-logo">
    <a href="#">
        <img src="<?php echo base_url('assets/dist/images/students.png'); ?>" alt="" class="img-fluid" style="width:50%;">
    </a>
  </div>
    ...
    <div class="card-body login-card-body">
      ...
      <form action="#" method="post" id="login-form">
        <div class="input-group mb-3">
          <input type="text" id="StudentGR" class="form-control" placeholder="StudentGR">
          <div id="StudentGR"></div>
...
<script>
      $('#login-form').submit(function (e) { /******** Call A Function When Login Form Submitted ********* */
        ...
        var StudentGR = $("#StudentGR").val(); /*********** Get StudentGR Value *********** */
        var Password = $("#Password").val(); /*******Get Phone Number Value ******* */
        if(StudentGR == ""){ /******** if StudentGR is empty ********* */
          $("#StudentGR").empty(); /*******make StudentGR validation div empty ****** */
          $("#StudentGR").addClass("cxm-err animated fadeInDown"); /**********add class to StudentGR validation div*********** */
          $("#StudentGR").append("StudentGR Required"); /*********Add Text to StudentGR validation********* */
          ...
          form_data.append("StudentGR", StudentGR); /********Add StudentGR to form ******* */
          form_data.append("Password", Password);  /*******add Password to form******* */
          $.ajax({ /********start of an ajax ******** */
            url:"<?php echo base_url('Login/SignInStudent'); ?>", /*******url to send ******* */
