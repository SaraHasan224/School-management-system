  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Subject's Marks</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item">Home</li>
              <li class="breadcrumb-item active">Subject's Marks</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <table id="dataTable1" class="table table-striped">
            <thead>
              <tr>
                ...
                <th class="text-center">Second Exam</th>
                <th class="text-center">Third Exam</th>
                <th class="text-center">Extra Activity</th>
            ...
            <tbody id="subject-table">
              ...
              if(!empty($STUS->FirstExam)){ $FirstExam =  $STUS->FirstExam; }else { $FirstExam = "0"; }
              if(!empty($STUS->SecondExam)){ $SecondExam =  $STUS->SecondExam; }else { $SecondExam = "0"; }
              if(!empty($STUS->ThirdExam)){ $ThirdExam =  $STUS->ThirdExam; }else { $ThirdExam = "0"; }
              if(!empty($STUS->ExtraActivityMarks)){ $ExtraActivityMarks =  $STUS->ExtraActivityMarks; }else { $ExtraActivityMarks = "0"; }
            
              $TotalMarks = $FirstExam + $SecondExam + $ThirdExam;
              ?> 
              <tr>
                <td class="text-center"><?php if(!empty($i)){ echo $i; } ?></td>
                <td class="text-center"><?php if(!empty($STUS->SubjectName)){ echo $STUS->SubjectName; } ?></td>
                <td class="text-center"><?php if(!empty($STUS->FirstExam)){ echo $STUS->FirstExam; }else { echo "0"; } ?></td>
                <td class="text-center"><?php if(!empty($STUS->SecondExam)){ echo $STUS->SecondExam; }else { echo "0"; } ?></td>
                <td class="text-center"><?php if(!empty($STUS->ThirdExam)){ echo $STUS->ThirdExam; }else { echo "0"; } ?></td>
                <td class="text-center"><?php if(!empty($STUS->ExtraActivityMarks)){ echo $STUS->ExtraActivityMarks; }else { echo "0"; } ?></td>
                <td class="text-center"><?php if(!empty($STUS->Grade)){ echo $STUS->Grade; }else { echo "0"; } ?></td>
                <td class="text-center"><?php if(!empty($STUS->Remarks)){ echo $STUS->Remarks; } ?></td>
                <td class="text-center"><?php if(!empty($TotalMarks)){ echo $TotalMarks; }else{ echo "0"; } ?></td>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-primary" id="updatemarks" disabled="true" onclick="UpdateMarks()">Save changes</button>
        </div>
      </div>
    </div>
  </div>
