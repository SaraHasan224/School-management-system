...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <!-- /.content-header -->
     ...
     <div class="content">
    <div class="mb-3">
      <a href="#CollapseAdd" data-toggle="collapse" class="btn btn-warning cxm-btn-1 rounded-pill px-3" data-toggle="tooltip" data-placement="top" title="" data-original-title="Add">Insert Syllabus</a>

      <div class="collapse addcollapse" id="CollapseAdd">
      <form action="#" method="post" id="cxm-syllabus-form">
        <div class="form-row">
          ...
          <div class="text-right">
            <button type="submit" class="btn btn-warning cxm-btn-1 rounded-pill px-3">Add Syllabus</button>
          </div>
        </div>
        </form>
      </div>
          ...
          <table id="dataTable1" class="table table-striped">
            ...
            <tbody id="subject-table">
              ...
              <tr>
                ...
                <td class="text-center" style="cursor:pointer;"><a href="<?php if(!empty($SUBJ->Syllabus)){ echo $SUBJ->Syllabus; } ?>" target="_blank"><i class="fa fa-download text-success"></i></a></td>
                
                <td class="text-center">
                  <div class="btn-group btn-group-sm" role="group">
                    <!-- <a href="#collapseRecored<?php //echo $i; ?>" data-toggle="collapse" class="btn btn-warning cxm-btn-1 fs13" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"><span class="fas fa-pencil-alt"></span></a> -->
                    <button class="btn btn-warning cxm-btn-1 fs13" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete" onclick="DeleteSyllabus(<?php if(!empty($SUBJ->SyllabusId)){ echo $SUBJ->SyllabusId; } ?>)"><span class="fas fa-trash-alt"></span></button>
                  </div>
                </td>
              </tr>
